...
function drawZoneAverage(events){
    ...
    document.getElementById("zoneAverage").innerHTMLhtml=
...
function getZoneColor(avg){
    ...
    if(avg>=0.500) return "#d32f2f";

    if(avg>=0.400) return "#f57c00";

    if(avg>=0.300) return "#fbc02d";

    if(avg>=0.200) return "#7cb342";
...
function createZoneLegend(){
    ...
    <div class="zoneLegend">
        ...
        <div><span style="background:#d32f2f"></span>.500以上</div>

        <div><span style="background:#f57c00"></span>.400以上</div>

        <div><span style="background:#fbc02d"></span>.300以上</div>

        <div><span style="background:#7cb342"></span>.200以上</div>

        <div><span style="background:#1e88e5"></span>.199以下</div>
